    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-10 offset-md-1">
                <form class="well form-horizontal" action="counselor-config-stream.php " method="post"  id="contact_form">
                    <fieldset>
                        <div class="form-group"> 
                            <label class="col-md-5 control-label">Stream</label>
                            <div class="col-md-5 selectContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
                                    <select name="sub1" class="form-control selectpicker" >
                                        <option value="xyz" >Please select your stream</option>
